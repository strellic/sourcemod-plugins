...
#define PLUGIN_VERSION		"3.1.2-CSGO-SB"

public Plugin:myinfo = {
	name        = "[Source 2013] Custom Chat Colors",
	author      = "Dr. McKay | Mitchell | AntiTeal",
...
public APLRes:AskPluginLoad2(Handle:myself, bool:late, String:error[], err_max) {
	...
	MarkNativeAsOptional("SB_GetChatRank");
...
{
	skillbot = LibraryExists("skillbot");
}
 
public void OnLibraryRemoved(const char[] name)
{
	if (StrEqual(name, "skillbot"))
	{
		skillbot = false;
	}
}
